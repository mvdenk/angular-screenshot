/*! Angular Screenshot - v0.5.0 - http://weihanchen.github.io/angular-screenshot - (c) 2017 weihanchen - MIT */
...
var _domToImage = __webpack_require__(332);
         ...
         return new Promise(function (resolve, reject) {
            ...
            $timeout(function () {
               ...
               return _domToImage2.default.toPng(element, options).then(_utils.domprocess.dataUrlToImage).then(function (image) {
                  _utils.domprocess.remove(image);
                  return _utils.domprocess.clipImageToCanvas(image, self.rect.startX || 0, self.rect.startY || 0, self.rect.w || options.width, self.rect.h || options.height);
               }).then(function (canvas) {
